 ...
 * It must contain URLs for `@joneugster/infoview`, `react`, `react/jsx-runtime`, `react-dom`,
 ...
 * ```js
 * {
 * '@joneugster/infoview': 'https://unpkg.com/@joneugster/infoview/dist/index.production.min.js',
 * 'react': 'https://unpkg.com/@joneugster/infoview/dist/react.production.min.js',
 * 'react/jsx-runtime': 'https://unpkg.com/@joneugster/infoview/dist/react-jsx-runtime.production.min.js',
 * 'react-dom': 'https://unpkg.com/@joneugster/infoview/dist/react-dom.production.min.js',
 * }
 * ```
 */
export function loadRenderInfoview(
    ...
    importShim('@joneugster/infoview')
        .then((mod: any) => next(mod.renderInfoview(...args)))
        .catch(ex => console.error(`Error importing '@joneugster/infoview': ${JSON.stringify(ex)}`))
}
